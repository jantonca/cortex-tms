...
<Terminal
  title="review.sh"
  language="bash"
  content="cortex review src/components/UserList.tsx"
/>

**Step 3**: Guardian catches violations

<Terminal
  title="guardian-output.txt"
  content={`🔍 Reviewing src/components/UserList.tsx
...
<Callout type="warning" title="Important Context">
...
<Terminal
  title="review.sh"
  language="bash"
  content={`cortex review website/src/pages/blog/index.astro
...
<Terminal
  title="manual-review.sh"
  language="bash"
  content={`# Review your changes before committing
cortex review src/`}
/>
...
<Terminal
  title=".github/workflows/guardian.yml"
  language="yaml"
  content={`# .github/workflows/guardian.yml
...
<Callout type="warning" title="False Positive Risk">
...
<Callout type="warning" title="Documentation Drift">
...
<Callout type="tip" title="Cost Transparency">
...
<Callout type="danger" title="Skip Guardian If">
