...
>
  This is our interpretation based on observing Claude Code's behavior. We don't
  have access to how Claude processes context internally. This could be wrong.
</Callout>
...
<Callout type="tip" title="Results Overview">
**What we measured**:
...
<Terminal
  title="NEXT-TASKS.md"
  language="markdown"
  content={`## Active Sprint: v2.6 Integrity & Atomicity
...
<Callout type="warning" title="Overhead vs Benefits">
...
<Callout type="tip" title="Prerequisites Checklist">
...
<Terminal
  title='validate.sh'
  language='bash'
  content='cortex validate --strict'
/>
...
<Terminal
  title="NEXT-TASKS.md (Bad Example)"
  language="markdown"
...
<Terminal
  title="NEXT-TASKS.md (Good Example)"
  language="markdown"
  content={`## Migration Checklist
...
<Callout type="warning" title="Open Question">
...
<Callout type="warning" title="Research Gaps">
**We don't know**:
