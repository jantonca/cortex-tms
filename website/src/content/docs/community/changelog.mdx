---
title: Changelog
description: Version history and release notes for Cortex TMS
---

import { Aside } from '@astrojs/starlight/components';

All notable changes to Cortex TMS are documented in this file. The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.0.0/), and this project adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).
...
## Version 3.1.0 (Current) - January 30, 2026

### ⚡ Feature Release - Git-Based Auto-Tiering

This release adds the community-requested **auto-tier** command, enabling automatic HOT/WARM/COLD tier assignment based on git commit history.

#### Added

**Git-Based Auto-Tiering** (`cortex-tms auto-tier`)
...
**Upgrade Recommendation**: All users should upgrade to v3.1.0 for improved tier management automation.
...
For complete technical details, see [sprint-v2.6-integrity-atomicity.md](https://github.com/cortex-tms/cortex-tms/blob/main/docs/archive/sprint-v2.6-integrity-atomicity.md).
...
<Aside type="caution" title="Beta Release">
...
<Aside type="tip">
**Migration Guide**: No breaking changes from v2.4.x. Simply upgrade with `npm install -g cortex-tms@2.5.0`.
</Aside>
...
<Aside type="caution" title="Critical Hotfix">
...
See [roadmap documentation](/concepts/roadmap) for planned features in upcoming versions.
...
```bash
npm install -g cortex-tms@2.5.0
```
...
```bash
npm install -g cortex-tms@2.4.0
```
...
npm install -g cortex-tms@2.6.0-beta.1
```
...
Cortex TMS follows [Semantic Versioning 2.0.0](https://semver.org/):
...
- **GitHub Releases**: [cortex-tms/cortex-tms/releases](https://github.com/cortex-tms/cortex-tms/releases) - Download source archives
- **NPM Package**: [npmjs.com/package/cortex-tms](https://www.npmjs.com/package/cortex-tms) - Install latest version
- **Contributing Guide**: [/community/contributing](/community/contributing) - Help improve Cortex TMS
- **Roadmap**: [/concepts/roadmap](/concepts/roadmap) - Upcoming features and vision

---

**Last Updated**: January 19, 2026
**Maintained By**: Cortex TMS Contributors
**Feedback**: Report changelog errors via [GitHub Issues](https://github.com/cortex-tms/cortex-tms/issues)
