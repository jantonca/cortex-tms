...
📊 Migration Report (Target: v2.6.0):
...
⚠️  CUSTOMIZED (1):
  FUTURE-ENHANCEMENTS.md v2.4.0 → v2.6.0 - File has custom changes
...
```
⚠️  CUSTOMIZED (1):
  docs/core/PATTERNS.md v2.5.0 → v2.6.0 - File has custom changes
```
