...
❯ 2026-01-19T10-30-00-123Z - v3.1.0 - 3 file(s) - 12.5 KB
...
📊 Migration Report (Target: v3.1.0):
...
⚠️  CUSTOMIZED (1):
  FUTURE-ENHANCEMENTS.md v2.4.0 → v3.1.0 - File has custom changes
...
```
⚠️  CUSTOMIZED (1):
  docs/core/PATTERNS.md v2.5.0 → v3.1.0 - File has custom changes
```
...
8. **Commit Migration**
   ...
   ```bash
   git add .
   git commit -m "chore: migrate TMS templates to v3.1.0"
   ```
...
<Tabs>
  ...
  <TabItem label="Review">
    ...
    # Commit
    git commit -am "chore: migrate TMS templates to v3.1.0"
    ```
  </TabItem>
</Tabs>
...
? Select a backup to restore:
❯ 2026-01-19T10-30-00-123Z - v3.1.0 - 3 file(s)
