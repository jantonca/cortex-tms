...
<Tabs>
  ...
  <TabItem label="Verbose Output">
    ...
    📏 File Size Limits (Rule 4)
      ✓ NEXT-TASKS.md under limit (185/200 lines)
        Current: 185 lines, Limit: 200 lines, Buffer: 15 lines
      ✓ copilot-instructions.md under limit (95/100 lines)
        Current: 95 lines, Limit: 100 lines, Buffer: 5 lines

    🔧 Placeholder Completion
      ✓ No placeholders found in NEXT-TASKS.md
      ✓ No placeholders found in CLAUDE.md
      ✓ No placeholders found in copilot-instructions.md

    📦 Archive Status
      ✓ NEXT-TASKS.md has no completed tasks requiring archive
